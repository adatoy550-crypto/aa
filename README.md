...
local InfiniteAmmo = makebutton("InfiniteAmmo: OFF",30)
-------------------------------------------------
-- HELPER
-------------------------------------------------
...
local function toggleInfiniteAmmo()
	...
	InfiniteAmmoEnabled = not aimbotEnabled
	InfiniteAmmoBtn.Text = "InfiniteAmmo: "..(InfiniteAmmoEnabled and "ON" or "OFF")
